        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: IndexedStack(
                index: _selectedTab,
                children: const [_FeedTab(), _MyGroupsTab(), _DiscoverTab()],
              ),
            ),
          ],
        ),
...
class _DiscoverTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return groupsAsync.when(
      ...
      error: (e, _) =>
          _EmptyGroupsPlaceholder(message: "No groups to discover right now."),
      data: (groups) {
        if (groups.isEmpty) {
          return _EmptyGroupsPlaceholder(
            message: "No groups to discover right now.",
          );
        }
        return ListView.separated(
          padding: const EdgeInsets.symmetric(
          ...
          itemBuilder: (ctx, i) {
            ...
            return _GroupCard(
              ...
              joined: false,
              onJoin: () async {
                await ref.read(groupsNotifierProvider.notifier).joinGroup(
                      g['id'].toString(),
                    );
