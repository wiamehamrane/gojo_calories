...
class NutritionGoalsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Edit Nutrition Goals', style: AppTextStyles.sectionHeader),
        ...
        children: [
          ...
          ElevatedButton(
            ...
            onPressed: () { 
              ...
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Nutrition goals saved!')));
            },
