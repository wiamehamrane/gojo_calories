...
class HealthConnectCard extends ConsumerStatefulWidget {
  const HealthConnectCard({super.key});

  @override
  ConsumerState<HealthConnectCard> createState() => _HealthConnectCardState();
}

class _HealthConnectCardState extends ConsumerState<HealthConnectCard> {
  @override
          ...
          Row(
            children: [
              ...
              if (health.isLoading)
                ...
                GestureDetector(
                  onTap: () => ref.read(healthSyncProvider.notifier).refresh(),
                  child: const Padding(
