...
class _ReferralsScreenState extends State<ReferralsScreen> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _PrimaryButton(
              label: Translations.t(lang, 'retry'),
              onTap: _fetchData,
            ),
          ],
        ),
  ...
  Widget _buildContent(String lang) {
    ...
    final totalWithdrawn =
        (_data?['total_withdrawn'] as num?)?.toDouble() ?? 0.0;
    final code = _data?['referral_code'] as String? ?? '------';
    final history =
        (_data?['referral_history'] as List?)?.cast<Map<String, dynamic>>() ??
        [];
    final withdrawals =
        (_data?['withdrawal_history'] as List?)?.cast<Map<String, dynamic>>() ??
        [];
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _StatCard(
                  label: Translations.t(lang, 'friends_stat'),
              ...
              Expanded(
                child: _StatCard(
                  label: Translations.t(lang, 'earned_stat'),
              ...
              Expanded(
                child: _StatCard(
                  label: Translations.t(lang, 'paid_out_stat'),
  ...
  Widget build(BuildContext context) {
    const steps = [
      ...
      (
        ...
        'Friend signs up',
        'They enter your code at registration',
      ),
      (
        LucideIcons.dollarSign,
        'Earn \$1',
        'Instantly credited to your balance',
      ),
    ];
...
class _WithdrawSheetState extends State<_WithdrawSheet> {
  ...
  Future<void> _submit() async {
    ...
    if (amount > widget.maxAmount) {
      setState(
        () => _error =
            'Amount exceeds your balance of \$${widget.maxAmount.toStringAsFixed(2)}.',
      );
      return;
    }
